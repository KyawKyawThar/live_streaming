...
const LiveStreamWebcam = () => {
    ...
    if (data.id) {
      ...
      if (mode === FORM_MODE.CREATE) {
        ...
        openNotifyModal(
          ...
          t('live.StreamStartSuccessTitle'),
          t('live.StreamStartSuccessDesc')
        );
  ...
  }, [isLiveEndEventReceived, streamDetails, navigate, openNotifyModal, t]);
          ...
          <div className="flex flex-col w-full h-full gap-3 overflow-hidden box-border">
            <div className="flex w-full lg:h-full items-center justify-center overflow-hidden">
              ...
              <div className="flex flex-col lg:flex-row w-full h-full gap-3">
                {/* Webcam View */}
                <div className="flex-1 flex items-center justify-center border rounded-md overflow-hidden relative bg-black">
                  {/* Live indicators */}
                  {isStreamStarted && (
