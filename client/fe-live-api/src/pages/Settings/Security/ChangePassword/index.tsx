  ...
  const onSubmit = async (formData: {
    ...
    if (data && data?.username && !_errors) {
      ...
      openNotifyModal(
        ...
        t('settings.SuccessChangePwdTitle'),
        t('settings.SuccessChangePwdDescription')
      );
    } else {
      if (_errors) {
      ...
      <div className="p-5 border rounded-md">
        <div className="flex justify-between items-center">
          ...
          <Button
            ...
            variant="outline"
          >
            {isFormOpen ? t('Cancel') : t('settings.ButtonChangePassword')}
          </Button>
        </div>
        ...
        {!isFormOpen ? (
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Button type="submit" disabled={isLoading}>
              ...
              {isLoading
                ? t('settings.ButtonUpdatingPassword')
                : t('settings.ButtonUpdatePassword')}
            </Button>
          </form>
        )}
      </div>
