    ...
    <div className="flex justify-between items-center gap-x-6 gap-y-4 py-4 border-b">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm font-medium text-gray-500 lowercase">
            {KMBformatter(subscriptionsCount)}{' '}
            {t('Subscriber', { count: subscriptionsCount })}
          </p>
          <p className="text-sm font-medium text-gray-500 lowercase">
            {videosCount} {t('Video', { count: videosCount })}
          </p>
        </div>
      </div>
      <div className="flex gap-2">
        ...
        <AppButton
          ...
          isIconActive={false}
          label={isNotiMute ? t('UnmuteNotification') : t('MuteNotification')}
