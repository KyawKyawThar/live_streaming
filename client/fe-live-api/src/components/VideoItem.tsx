        ...
        >
          ...
          {isVideo && (
            <OverlayStats
              ...
              content={`${video?.views} ${t('View', { count: video?.views })}`}
            />
          )}
          ...
          {isLive && (
            <OverlayStats
              ...
              content={`${t('Live')} ${getTimeAgoFormat(video.started_at)}`}
            />
          )}
          {isVideo && (
            <OverlayStats
          ...
          {isUpcoming && (
            <OverlayStats
              classes="bottom-2 right-2"
              content={`${t('LiveOn')} ${getFormattedDate(
