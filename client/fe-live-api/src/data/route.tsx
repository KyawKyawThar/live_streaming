...
export const ROUTE_PATH_INFO = {
  [FEED_PATH]: {
    path: FEED_PATH,
    title: <Trans i18nKey="Feed" />,
    Icon: <Frame />,
  },
  [SUBSCRIPTIONS_PATH]: {
    path: SUBSCRIPTIONS_PATH,
    title: <Trans i18nKey="Subscriptions" />,
    Icon: <Rss />,
  },
  [HISTORY_PATH]: {
    path: HISTORY_PATH,
  ...
  [LIKED_VIDEOS_PATH]: {
    ...
    title: <Trans i18nKey="LikedVideos" />,
    Icon: <ThumbsUp />,
  },
  [SAVED_VIDEOS_PATH]: {
    path: SAVED_VIDEOS_PATH,
    title: <Trans i18nKey="BookmarkVideos" />,
    Icon: <Bookmark />,
  },
  [LIVE_STREAM_PATH]: {
    path: LIVE_STREAM_PATH,
    title: <Trans i18nKey="LiveStream" />,
    Icon: <Radio />,
  },
  [SETTINGS_PATH]: {
    path: SETTINGS_PATH,
