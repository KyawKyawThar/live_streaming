...
func BuildErrorResponse(ctx echo.Context, status int, err error, body interface{}, customError string) error {
	return BuildStandardResponse(ctx, status, Response{Message: err.Error(), Code: status, Data: body, Error: customError})
}
