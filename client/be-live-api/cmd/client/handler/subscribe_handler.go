...
func (h *subscribeHandler) mute(c echo.Context) error {
	...
	if subscription == nil {
		return utils.BuildErrorResponse(c, http.StatusInternalServerError, errors.New("you have not subscribed to the above channel, you can't update"), nil, "INTERNAL_ERROR")
	}
