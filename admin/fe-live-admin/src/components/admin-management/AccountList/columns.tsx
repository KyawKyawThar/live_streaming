...
export const getAccountsListTableColumns = ({
...
}: ColumnsProps): ColumnDef<UserResponse>[] => [
  {
    ...
    header: () => (
      <DataTableColumnHeader
        title={<Trans i18nKey={ColumnNames.displayName.label} />}
        sort={{
                ...
                <Popover>
                  ...
                  >
                    <h3 className="font-semibold mb-2 text-red-600">
                      <Trans i18nKey="accountList.BlockedReason" />
                    </h3>
                    <p className="">
  ...
  },
  {
    ...
    header: () => (
      <DataTableColumnHeader
        title={<Trans i18nKey={ColumnNames.username.label} />}
        sort={{
  ...
  },
  {
    ...
    header: () => (
      <DataTableColumnHeader
        title={<Trans i18nKey={ColumnNames.creator.label} />}
      />
    ),
    cell: ({ row }) => {
      ...
      return (
        <span className="italic text-muted-foreground">
          <Trans i18nKey="accountList.SelfCreated" />
        </span>
      );
    },
  },
  {
    ...
    header: () => (
      <DataTableColumnHeader
        title={<Trans i18nKey={ColumnNames.createdAt.label} />}
        sort={{
  ...
  },
  {
    ...
    header: () => (
      <DataTableColumnHeader
        title={<Trans i18nKey={ColumnNames.updater.label} />}
      />
    ),
    cell: ({ row }) => {
  ...
  },
  {
    id: 'actions',
    header: () => (
      <DataTableColumnHeader title={<Trans i18nKey={'Actions'} />} />
    ),
    enableHiding: false,
    cell: ({ row }) => {
