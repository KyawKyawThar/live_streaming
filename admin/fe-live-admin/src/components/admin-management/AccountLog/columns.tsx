...
import { ColumnNames } from "@/components/admin-management/AccountLog/columnData.ts";
...
export const getAccountLogTableColumns = ({
  sort,
}: ColumnsProps): ColumnDef<ActivityLogResponse>[] => {
  ...
  return [
    {
      ...
      header: () => (
        <DataTableColumnHeader
          title={t(ColumnNames.user.label)}
          sort={{
    ...
    },
    {
      ...
      header: () => (
        <DataTableColumnHeader
          title={t(ColumnNames.action.label)}
          sort={{
      ...
      cell: ({ row }) => {
        ...
        return <p className="font-medium">{action}</p>;
      },
    },
    {
      accessorKey: "details",
      header: () => (
        <DataTableColumnHeader
          title={t(ColumnNames.details.label)}
          sort={{
      ...
      cell: ({ row }) => {
        ...
        return <p className="font-medium">{details}</p>;
      },
    },
    {
      accessorKey: "date",
      header: () => (
        <DataTableColumnHeader
          title={t(ColumnNames.date.label)}
          sort={{
