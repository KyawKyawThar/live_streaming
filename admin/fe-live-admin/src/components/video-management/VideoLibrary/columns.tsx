...
export const getVideosTableColumns = ({ sort }: ColumnsProps) => [
  {
    ...
    header: () => (
      <DataTableColumnHeader
        title={<Trans i18nKey={ColumnNames.video.label} />}
        sort={{
  ...
  },
  {
    ...
    header: () => (
      <DataTableColumnHeader
        title={<Trans i18nKey={ColumnNames.started_At.label} />}
        sort={{
  ...
  },
  {
    ...
    header: () => (
      <DataTableColumnHeader
        title={<Trans i18nKey={ColumnNames.ended_At.label} />}
        sort={{
  ...
  {
    accessorKey: 'creator',
    header: () => <Trans i18nKey={ColumnNames.creator.label} />,
    cell: ({ row }: any) => {
  ...
  },
  {
    ...
    header: () => (
      <DataTableColumnHeader
        title={<Trans i18nKey={ColumnNames.type.label} />}
      />
    ),
    cell: ({ row }: any) => {
  ...
  },
  {
    ...
    header: () => (
      <DataTableColumnHeader
        title={<Trans i18nKey={ColumnNames.category.label} />}
      />
    ),
    cell: ({ row }: any) => {
  ...
  },
  {
    ...
    header: () => (
      <DataTableColumnHeader
        title={<Trans i18nKey={ColumnNames.size.label} />}
        sort={{
  ...
  },
  {
    ...
    header: () => (
      <DataTableColumnHeader
        title={<Trans i18nKey={ColumnNames.duration.label} />}
        sort={{
...

  {
    ...
    header: () => (
      <DataTableColumnHeader
        title={<Trans i18nKey={ColumnNames.likes.label} />}
        sort={{
  ...
  },
  {
    ...
    header: () => (
      <DataTableColumnHeader
        title={<Trans i18nKey={ColumnNames.viewers.label} />}
        sort={{
  ...
  },
  {
    ...
    header: () => (
      <DataTableColumnHeader
        title={<Trans i18nKey={ColumnNames.shares.label} />}
        sort={{
  ...
  },
  {
    ...
    header: () => (
      <DataTableColumnHeader
        title={<Trans i18nKey={ColumnNames.comments.label} />}
        sort={{
