    ...
    <Dialog open={openPreviewDialog} onOpenChange={setOpenPreviewDialog}>
      <DialogTrigger asChild>
        <Button variant="outline">
          <TextSearch /> {t('upcomingSession.Preview')}
        </Button>
      </DialogTrigger>
      <DialogContent className="max-w-[30rem] md:max-w-[36rem] lg:max-w-[45rem] xl:max-w-[50rem] 2xl:max-w-[60rem]">
          ...
          <div className="grid grid-cols-5 gap-5">
            <div className="col-span-3 space-y-4">
              <div className="grid grid-cols-6">
                <FieldLabel isRequired={true} label={t('Title')} />
                <Textarea
              ...
              <div className="grid grid-cols-6">
                <FieldLabel isRequired={true} label={t('Description')} />
                <Textarea
                  className="col-span-5"
              ...
              <div className="flex flex-col gap-4">
                <FieldLabel isRequired={true} label={t('ScheduleTime')} />
                <div className="">
                  <DateTimePicker
                    width="w-full"
                    value={scheduledAt}
                ...
                <div className="flex flex-row items-center justify-between">
                  <div className="space-y-0.5 flex flex-col">
                    <Label className="text-base">
                      {t('upcomingSession.ChangeVideoTitle')}
                    </Label>
                    <span className="text-xs">
                      {t('upcomingSession.ChangeVideoDesc')}
                    </span>
                  </div>
                  <Switch
              ...
              <div className="flex flex-col rounded-lg border p-4 space-y-4">
                <div className="flex flex-row items-center justify-between">
                  <div className="space-y-0.5 flex flex-col">
                    <Label className="text-base">
                      {t('upcomingSession.ChangeThumbnailTitle')}
                    </Label>
                    <span className="text-xs">
                      {t('upcomingSession.ChangeThumbnailDesc')}
                    </span>
                  </div>
                  <Switch
        ...
        <DialogFooter className="justify-end">
          <DialogClose asChild>
            ...
            >
              {t('upcomingSession.CancelChangeAndClose')}
            </Button>
          </DialogClose>
          <Button
            className={`${!shouldAllowUpdate()}` ? '' : 'cursor-pointer'}
