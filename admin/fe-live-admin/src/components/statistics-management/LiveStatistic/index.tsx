import { getLiveStatisticTableColumns } from '@/components/statistics-management/LiveStatistic/columns.tsx';
      ...
      <div className="py-4">
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem>
              <BreadcrumbLink>
                <NavLink to={APP_DASHBOARD_PATH}>{t('Dashboard')}</NavLink>
              </BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator>
              <Slash />
            ...
            <BreadcrumbItem>
              <BreadcrumbPage>
                {t('sidebar.StatisticsManagement.LiveStats')}
              </BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
