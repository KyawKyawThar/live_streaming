...
export const ITEM_INFO = {
  APP_ACCOUNT_LIST_PATH: {
    title: <Trans i18nKey="sidebar.AccountManagement.AccountList" />,
    url: APP_ACCOUNT_LIST_PATH,
    icon: Users,
  },
  APP_ACCOUNT_LOG_PATH: {
    title: <Trans i18nKey="sidebar.AccountManagement.AccountLog" />,
    url: APP_ACCOUNT_LOG_PATH,
    icon: Users,
  },
  APP_LIVE_SESSION_PATH: {
    title: <Trans i18nKey="sidebar.LiveManagement.LiveSession" />,
    url: APP_LIVE_SESSION_PATH,
    icon: Radio,
  },
  APP_LIVE_CATEGORY_PATH: {
    title: <Trans i18nKey="sidebar.LiveManagement.CategoryList" />,
    url: APP_LIVE_CATEGORY_PATH,
    icon: Radio,
  },
  APP_VIDEO_LIBRARY_PATH: {
    title: <Trans i18nKey="sidebar.VideoManagement.VideoLibrary" />,
    url: APP_VIDEO_LIBRARY_PATH,
    icon: FileVideo,
  },
  APP_LIVE_STATISTIC_PATH: {
    title: <Trans i18nKey="sidebar.StatisticsManagement.LiveStats" />,
    url: APP_LIVE_STATISTIC_PATH,
    icon: FileChartColumn,
  },
  APP_VIDEO_STATISTIC_PATH: {
    title: <Trans i18nKey="sidebar.StatisticsManagement.VideoStats" />,
    url: APP_VIDEO_STATISTIC_PATH,
    icon: FileChartColumnIncreasing,
  },
  APP_USER_STATISTICS_PATH: {
    title: <Trans i18nKey="sidebar.StatisticsManagement.UserStats" />,
    url: APP_USER_STATISTICS_PATH,
    icon: FileChartColumnIncreasing,
  },
  APP_UPCOMING_SESSION_PATH: {
    title: <Trans i18nKey="sidebar.LiveManagement.UpcomingSession" />,
